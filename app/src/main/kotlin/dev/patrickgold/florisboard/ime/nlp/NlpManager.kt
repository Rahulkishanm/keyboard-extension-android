...
//
//            }
            if(currentWord.lowercase().contains("rapyd")){
                val currency = currentWord.filter { it.isDigit() }
                add("https://freshcatch-700a3.firebaseapp.com/9489565979/carts?amt=$currency")
            }
        }
